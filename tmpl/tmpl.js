...
/**
 * Область имен классов шаблонизатора.
 * @namespace
 */
tuna.tmpl = {};
...
/**
 * Область имен классов компиляции шаблонов.
 * @namespace
 */
tuna.tmpl.compilers = {};
...
/**
 * Область имен классов работы с данными шаблонизатора.
 * @namespace
 */
tuna.tmpl.data = {};
...
/**
 * Область имен классов обработки разметки шаблона.
 * @namespace
 */
tuna.tmpl.markup = {};
...
/**
 * Область имен классов описывающих шаблон трансформации.
 * @namespace
 */
tuna.tmpl.settings = {};
...
/**
 * Область имен классов реализующих трансформацию.
 * @namespace
 */
tuna.tmpl.units = {};
...
/**
 * Область имен классов вспомогательных для элемента списка.
 * @namespace
 */
...
/**
 * Область имен классов вспомогательных для элемента условия.
 * @namespace
 */
